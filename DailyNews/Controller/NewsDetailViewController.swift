...
class NewsDetailViewController: UIViewController, SFSafariViewControllerDelegate {
    ...
    @IBOutlet weak var contentTextView: UITextView! {
        didSet {
            ...
            contentTextView.font = UIFont.preferredFont(forTextStyle: UIFont.TextStyle.subheadline)
    ...
    @IBAction func shareArticle(_ sender: UIButton) {
        ...
        DispatchQueue.main.asyncAfter(deadline: delay) {
            ...
            activityVC.excludedActivityTypes = [UIActivity.ActivityType.saveToCameraRoll,
